  ...
  if(length(JustNowMemes)>0){
    ...
    repeat{
      ...
      if(new_meme != previous_meme){
        ...
        print('Todays tweet')
        tweeting_meme <- post_tweet(status = '#meme #memeforeveryone #memes #ilovememes #memesdaily #Valentinesday #Valentinesday2022 \U0001F923 \U0001F923 \U0001F923 \U0001f602',media = current_meme,token = token)
        unlink(current_meme)
